...
![Alt text](<../assets/컴퓨터-구조론-(3)-데이터패스-(1)/image-1.png>)

인출된 명령어는 명령어 구조에 따라 해독되어 레지스터와 컨트롤 유닛에게 전달된다.

# 명령어 해독

![Alt text](<../assets/컴퓨터-구조론-(3)-데이터패스-(1)/image-2.png>)
...
![Alt text](<../assets/컴퓨터-구조론-(3)-데이터패스-(1)/image-3.png>)
...
![Alt text](<../assets/컴퓨터-구조론-(3)-데이터패스-(1)/image-4.png>)
...
![Alt text](<../assets/컴퓨터-구조론-(3)-데이터패스-(1)/image-5.png>)
...
![Alt text](<../assets/컴퓨터-구조론-(3)-데이터패스-(1)/image.png>)
